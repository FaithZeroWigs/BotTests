...
namespace Microsoft.BotBuilderSamples
{
    ...
    public class MultiTurnPromptsBot : IBot
    {
        ...
        {
            Regex regex = new Regex(".*(I am|This is)\\s*(?<name>[^\\s].+)", RegexOptions.IgnoreCase | RegexOptions.CultureInvariant);
            var match = regex.Match(stepContext.Context.Activity.Text);
            ...
            {
                return await stepContext.NextAsync(name.Value, cancellationToken);
            }
        }
